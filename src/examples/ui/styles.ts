export default function (_ctx: Context, _session: Session | null, _opts?: {}) {
    ...
    field: "ifta-field group grid min-w-0 grid-rows-[auto_1fr] bg-[#fffefa] transition-colors focus-within:bg-white [&>span]:px-3 [&>span]:pt-[4px] [&>span]:text-[.46rem] [&>span]:font-black [&>span]:uppercase [&>span]:tracking-[.18em] [&>span]:text-[#686d6b]",
